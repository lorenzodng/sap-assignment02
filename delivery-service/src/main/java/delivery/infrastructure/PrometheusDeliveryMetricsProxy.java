...
public class PrometheusDeliveryMetricsProxy implements DeliveryMetrics {
    ...
    public PrometheusDeliveryMetricsProxy(int port) throws Exception {
        ...
        activeDeliveries = Gauge.builder().name("delivery_deliveries_active").help("Number of shipments currently in progress").register();
        completedDeliveries = Counter.builder().name("delivery_completed_total").help("Total number of completed deliveries").register();
